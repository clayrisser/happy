...
export class CodexPermissionHandler extends BasePermissionHandler {
    ...
    async handleToolCall(
        ...
        // The raise-and-wait itself is the base class's (DROVE-316). Everything
        // above this line is the Codex-specific part.
        return super.handleToolCall(toolCallId, toolName, input);
    }
}
