...
export function showMicrophonePermissionDeniedAlert(canAskAgain: boolean = false) {
  ...
  const message = canAskAgain
    ? 'Cattle Drover needs access to your microphone for voice chat. Please grant permission when prompted.'
    : 'Cattle Drover needs access to your microphone for voice chat. Please enable microphone access in your device settings.';
