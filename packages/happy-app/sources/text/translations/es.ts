...
export const es: TranslationStructure = {
    ...
    allTimeTokens: {
        ...
        total: ({ tokens }: { tokens: string }) => `${tokens} en todas las sesiones`,
        unattributed: 'Sin atribuir',
        empty: 'Todavía no hay nada contado.',
        footer: 'Contado en este dispositivo, mientras estaba conectado.',
        since: ({ when }: { when: string }) => `Contando desde ${when}`,
        accessibility: ({ tokens }: { tokens: string }) => `${tokens} tokens usados en total`,
        accessibilityHint: 'Pulsa para ver el desglose por modelo, mantén pulsado para reiniciar',
        resetTitle: '¿Reiniciar el contador de tokens?',
        resetMessage: 'El total y su desglose por modelo vuelven a cero. Esto no se puede deshacer.',
        resetConfirm: 'Reiniciar',
        resetCancel: 'Conservar',
    },
    status: {
        connected: 'conectado',
        connecting: 'conectando',
    ...
    errors: {
        ...
        voiceNotAllowed: 'El servidor de voz rechazó iniciar el modo jefe. Necesita minutos de voz o una suscripción en ese servidor, y esta versión no puede mostrar la pantalla de pago.',
    ...
    server: {
        ...
        continueWithServer: 'Misma clave, misma cuenta. Las sesiones no te siguen: el nuevo servidor empieza vacío.',
        ...
        advancedFeatureFooter: 'Avanzado. Al cambiar se inicia sesión en el nuevo servidor con la clave que ya tienes; sin cerrar sesión.',
        reauthenticating: 'Iniciando sesión en el nuevo servidor…',
        reauthFailed: 'No se pudo iniciar sesión allí con tu clave. No ha cambiado nada.',
        services: 'Servicios',
    ...
    sessionInfo: {
        ...
        remoteControlTitle: 'Control remoto',
        remoteControl: 'Control remoto de Claude Code',
        remoteControlOn: 'Activado — puedes llegar a esta sesión desde el móvil y desde claude.ai/code',
        remoteControlOff: 'Desactivado — las respuestas se quedan en la terminal',
        remoteControlPending: 'Esperando a que se abra el prompt…',
        remoteControlUnknown: 'La terminal aún no lo ha dicho',
        remoteControlFooter: 'Lee lo que el panel está haciendo de verdad, así /remote-control escrito en la terminal también aparece aquí.',
        remoteControlUnknownFooter: 'No se puede cambiar nada hasta que la sesión informe si el control remoto está activado.',
        remoteControlTurnOn: 'Activar',
        remoteControlAtRiskTitle: 'Se quedaron mudas tras el cambio',
        remoteControlAtRiskFooter: 'Claude Code ata el control remoto a una cuenta por máquina, así que mover esta sesión lo desactivó para estas.',
        ...
        updateCliInstructions: 'Por favor ejecute npm install -g drover@latest',
    ...
    agentInput: {
        streamTalk: {
            ...
            paused: 'En pausa. Mantén pulsado para continuar donde se quedó',
            resumed: 'Continuando la lectura desde donde se quedó',
            headphonesOff: 'Auriculares desconectados, lectura en pausa',
        },
        audioOut: {
        ...
        usagePopup: {
            ...
            familyWeek: ({ family }: { family: string }) => `Semana ${family}`,
            left: ({ percent }: { percent: number }) => `${percent}% restante`,
            used: ({ percent }: { percent: number }) => `${percent}% usado`,
            leftOn: ({ percent, window }: { percent: number; window: string }) =>
                `${percent}% left on ${window}`,
            back: ({ time }: { time: string }) => `Vuelve ${time}`,
            familyBack: ({ family, time }: { family: string; time: string }) => `${family} vuelve ${time}`,
    ...
    toolGroup: {
        ...
        ranShellCommands: ({ count }: { count: number }) => count === 1 ? 'Se ejecutó 1 comando de shell' : `Se ejecutaron ${count} comandos de shell`,
    ...
    tools: {
        ...
        agent: {
            ...
            prompt: 'Instrucción',
            result: 'Resultado',
            toolUses: ({ count }: { count: number }) => count === 1 ? '1 uso de herramienta' : `${count} usos de herramientas`,
            details: 'Detalles',
        },
        taskView: {
            ...
            showAll: ({ count }: { count: number }) => `Ver los ${count} pasos`,
            showLess: 'Ver menos',
        },
        multiEdit: {
    ...
    settingsVoice: {
        ...
        speaking: {
            ...
            automaticSubtitle: ({ name }: { name: string }) => `Mejor voz instalada: ${name}`,
            automaticNone: 'No hay ninguna voz instalada para este idioma',
            preview: 'Escuchar',
            previewSentence: 'Las pruebas pasan, cambiaron dos archivos y nada más se movió.',
            qualityPremium: 'Premium',
            qualityEnhanced: 'Mejorada',
            qualityDefault: 'Compacta',
            personal: 'Voz personal',
            deliveryTitle: 'Entrega',
            deliveryFooter: 'La velocidad y el tono se aplican a cualquier voz. Una respuesta terminada se lee hasta el final, por larga que sea. Mientras todavía se escribe, si queda más audio por decir que el umbral, la voz dice «saltando adelante» y continúa desde la frase más reciente; y una respuesta nueva siempre abandona la anterior.',
            rate: 'Velocidad',
            catchUpRate: 'Velocidad con retraso',
            pitch: 'Tono',
            backlog: 'Acelerar con un retraso de',
            jump: 'Saltar con un retraso de',
            seconds: ({ seconds }: { seconds: number }) => `${seconds} s`,
            noNaturalVoice: ({ language }: { language: string }) => `No hay ninguna voz mejorada o premium instalada para ${language}, así que las respuestas usan la compacta. En Ajustes, ve a Accesibilidad > Contenido leído > Voces y descarga una.`,
            openSettings: 'Abrir Ajustes',
        },
        cues: {
            title: 'Señales de audio',
            footer: 'Sonidos para no mirar la pantalla. Un golpe grave y lento mientras algo se ejecuta, un pulso brillante y más rápido mientras algo te espera, y silencio cuando no pasa nada. El habla siempre gana: una señal nunca suena encima de una frase hablada.',
            on: 'Señales de audio',
            onSubtitle: 'El latido y los sonidos puntuales.',
            heartbeat: 'Latido',
            heartbeatSubtitle: 'Pulso mientras hay trabajo en marcha y no se está hablando.',
            volume: 'Volumen',
            vsVoice: 'Nivel de señales vs voz',
            workingEvery: 'Pulso de trabajo cada',
            waitingEvery: 'Pulso de espera cada',
            titlesTitle: 'Títulos hablados',
            titlesFooter: 'El título de una línea de una llamada de herramienta, de terminal o de un agente al arrancar, leído más rápido y más agudo que la respuesta para que nunca suene como Claude hablando. Una serie de llamadas tiene límite; los agentes siempre se nombran.',
            speakTitles: 'Leer los títulos en voz alta',
            agentTitles: 'Títulos de agentes',
            agentTitlesSubtitle: 'Nunca se omiten.',
            toolTitles: 'Títulos de herramientas y terminal',
            titlesPerRun: 'Títulos por serie de llamadas',
            tableTitle: 'Los sonidos',
            tableFooter: 'Toca una fila para silenciarla, o el botón de reproducir para oírla.',
            play: 'Reproducir',
        },
    },
    ...
    machine: {
        ...
        offlineHelp: '• Asegúrate de que tu computadora esté en línea\n• Ejecuta `drover daemon status` para diagnosticar\n• ¿Estás usando la última versión del CLI? Actualiza con `npm install -g drover@latest`',
    ...
    message: {
        ...
        agentRunning: ({ duration }: { duration: string }) => `Agente en curso · ${duration}`,
        agentFinished: ({ duration }: { duration: string }) => `Agente finalizado · ${duration}`,
    },
    ...
    subagent: {
        ...
        failed: 'Falló',
        quiet: ({ duration }: { duration: string }) => `en silencio desde hace ${duration}`,
    ...
    imageUpload: {
        ...
        notSupportedFragment: 'este agente no acepta imágenes',
        // The Add context sheet the plus opens (DROVE-128).
        addContextTitle: 'Añadir contexto',
        sourceCamera: 'Cámara',
        sourcePhotos: 'Fotos',
        sourceFiles: 'Archivos',
        cameraPermissionTitle: 'Acceso a la cámara',
        cameraPermissionMessage: 'Permite el acceso a la cámara para adjuntar fotos a los mensajes.',
    },
