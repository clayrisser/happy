...
export const es: TranslationStructure = {
    ...
    settingsVoice: {
        ...
        speaking: {
            ...
            deliveryFooter: 'La velocidad y el tono se aplican a cualquier voz. Cuando la voz se retrasa respecto al texto más que el umbral, descarta lo pendiente, dice «saltando adelante» y continúa desde la frase más reciente.',
            rate: 'Velocidad',
            pitch: 'Tono',
            lag: 'Saltar adelante tras',
