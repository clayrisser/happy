...
export const zhHant: TranslationStructure = {
    ...
    server: {
        ...
        changeServer: '更改伺服器',
        continueWithServer: '同一把金鑰就是同一個帳戶。工作階段不會跟著走：新伺服器從空開始。',
        ...
        advancedFeatureFooter: '進階功能。切換會用你已有的金鑰登入新伺服器，不必登出。',
        reauthenticating: '正在登入新伺服器…',
        reauthFailed: '無法用你的金鑰登入該伺服器。沒有任何變更。',
        services: '服務',
    ...
    sessionInfo: {
        ...
        sequence: '序列',
        quickActions: '快速操作',
        remoteControlTitle: '遠端控制',
        remoteControl: 'Claude Code 遠端控制',
        remoteControlOn: '開 — 可以從手機和 claude.ai/code 操作這個工作階段',
        remoteControlOff: '關 — 回覆只留在終端機裡',
        remoteControlPending: '正在等待提示字元空出來…',
        remoteControlUnknown: '終端機還沒回報',
        remoteControlFooter: '讀取窗格真正的狀態，所以在終端機裡敲的 /remote-control 這裡也會顯示。',
        remoteControlUnknownFooter: '在工作階段回報遠端控制狀態之前無法切換。',
        remoteControlTurnOn: '開啟',
        remoteControlAtRiskTitle: '換帳號後安靜下來的工作階段',
        remoteControlAtRiskFooter: 'Claude Code 每台機器只把遠端控制綁定到一個帳號，所以移動這個工作階段切斷了它們。',
        viewMachine: '查看裝置',
        ...
        updateCliInstructions: '請執行 npm install -g drover@latest',
    ...
    agentInput: {
        ...
        usagePopup: {
            ...
            left: ({ percent }: { percent: number }) => `剩餘 ${percent}%`,
    ...
    settingsVoice: {
        ...
        speaking: {
            ...
            automatic: '自動',
            automaticSubtitle: ({ name }: { name: string }) => `已安裝的最佳聲音：${name}`,
            automaticNone: '此語言沒有已安裝的聲音',
            preview: '試聽',
            previewSentence: '測試通過，兩個檔案有變動，其他沒有變化。',
            qualityPremium: '高級',
            qualityEnhanced: '增強',
            qualityDefault: '精簡',
            personal: '個人聲音',
            deliveryTitle: '朗讀方式',
            deliveryFooter: '語速和音調適用於所有聲音。已經寫完的回覆無論多長都會讀完。回覆仍在產生時，若未讀的音訊超過門檻，才會說「跳到最新」並從最新的句子繼續；新的回覆總會放棄上一則。',
            rate: '語速',
            catchUpRate: '落後時的語速',
            pitch: '音調',
            backlog: '落後超過此時長時加速',
            ...
            noNaturalVoice: ({ language }: { language: string }) => `${language} 沒有安裝增強或高級聲音，回覆會用精簡聲音朗讀。請在設定中前往 輔助使用 > 朗讀內容 > 聲音 下載一個。`,
            openSettings: '開啟設定',
        },
        cues: {
            title: '音訊提示',
            footer: '不用看螢幕的聲音。有工作在跑時是緩慢的低沉心跳，有事等你處理時是更快更亮的脈衝，什麼都沒發生時保持安靜。語音永遠優先：提示音不會蓋在正在朗讀的句子上。',
            on: '音訊提示',
            onSubtitle: '心跳與一次性提示音。',
            heartbeat: '心跳',
            ...
            waitingEvery: '等待脈衝間隔',
            titlesTitle: '朗讀標題',
            titlesFooter: '朗讀工具呼叫、終端機呼叫與新啟動代理的一行標題，語速更快、音調更高，不會聽起來像 Claude 在說話。連續的工具呼叫有數量上限，代理則一律朗讀。',
            speakTitles: '朗讀標題',
            agentTitles: '代理標題',
            agentTitlesSubtitle: '從不省略。',
            toolTitles: '工具與終端機標題',
            titlesPerRun: '每串工具呼叫朗讀的標題數',
            tableTitle: '聲音',
            tableFooter: '點一列將其靜音，點播放按鈕試聽。',
            play: '播放',
        },
    },
    ...
    machine: {
        ...
        offlineHelp: '• 確保您的電腦在線上\n• 執行 `drover daemon status` 進行診斷\n• 您是否在執行最新的 CLI 版本？請使用 `npm install -g drover@latest` 升級',
        daemon: '守護程序',
        status: '狀態',
        stopDaemon: '停止守護程序',
