...
export const pl: TranslationStructure = {
    ...
    errors: {
        ...
        voiceNotAllowed: 'Serwer głosowy odmówił uruchomienia trybu szefa. Wymaga minut głosowych lub subskrypcji na tym serwerze, a ta wersja nie może wyświetlić paywalla.',
    ...
    sessionInfo: {
        ...
        remoteControlTitle: 'Zdalne sterowanie',
        remoteControl: 'Zdalne sterowanie Claude Code',
        remoteControlOn: 'Włączone — tę sesję można prowadzić z telefonu i z claude.ai/code',
        remoteControlOff: 'Wyłączone — odpowiedzi zostają w terminalu',
        remoteControlPending: 'Czekam, aż zwolni się prompt…',
        remoteControlUnknown: 'Terminal jeszcze nie odpowiedział',
        remoteControlFooter: 'Czyta to, co panel naprawdę robi, więc /remote-control wpisane w terminalu też się tu pojawi.',
        remoteControlUnknownFooter: 'Nic nie da się przełączyć, dopóki sesja nie zgłosi stanu zdalnego sterowania.',
        remoteControlTurnOn: 'Włącz',
        remoteControlAtRiskTitle: 'Ucichły po przełączeniu konta',
        remoteControlAtRiskFooter: 'Claude Code wiąże zdalne sterowanie z jednym kontem na maszynę, więc przeniesienie tej sesji odcięło tamte.',
        ...
        updateCliInstructions: 'Proszę uruchomić npm install -g drover@latest',
    ...
    agentInput: {
        ...
        usagePopup: {
            ...
            familyWeek: ({ family }: { family: string }) => `Tydzień ${family}`,
            left: ({ percent }: { percent: number }) => `${percent}% pozostało`,
    ...
    toolGroup: {
        ...
        ranShellCommands: ({ count }: { count: number }) => `${plural({ count, one: 'Wykonano 1 polecenie powłoki', few: `Wykonano ${count} polecenia powłoki`, many: `Wykonano ${count} poleceń powłoki` })}`,
    ...
    tools: {
        ...
        sendMessage: {
            to: ({ to }: { to: string }) => `Wiadomość do ${to}`,
            untitled: 'Wiadomość',
            message: 'Wiadomość',
        ...
        agent: {
            ...
            prompt: 'Polecenie',
            result: 'Wynik',
            toolUses: ({ count }: { count: number }) => count === 1 ? '1 użycie narzędzia' : `${count} użyć narzędzi`,
            details: 'Szczegóły',
        },
        taskView: {
            ...
            showAll: ({ count }: { count: number }) => `Pokaż wszystkie kroki (${count})`,
            showLess: 'Pokaż mniej',
        },
        multiEdit: {
    ...
    settingsVoice: {
        ...
        speaking: {
            ...
            automaticSubtitle: ({ name }: { name: string }) => `Najlepszy zainstalowany głos: ${name}`,
            automaticNone: 'Brak zainstalowanego głosu dla tego języka',
            preview: 'Odsłuchaj',
            previewSentence: 'Testy przechodzą, zmieniły się dwa pliki i nic więcej.',
            qualityPremium: 'Premium',
            qualityEnhanced: 'Ulepszony',
            qualityDefault: 'Kompaktowy',
            personal: 'Głos osobisty',
            deliveryTitle: 'Sposób mówienia',
            deliveryFooter: 'Tempo i wysokość dotyczą każdego głosu. Skończona odpowiedź jest czytana do końca, choćby była długa. Gdy odpowiedź wciąż powstaje, a niewypowiedzianego dźwięku zostaje więcej niż próg, głos mówi „przeskakuję dalej” i kontynuuje od najnowszego zdania; nowa odpowiedź zawsze porzuca poprzednią.',
            rate: 'Tempo',
            catchUpRate: 'Prędkość przy zaległościach',
            pitch: 'Wysokość',
            backlog: 'Przyspiesz przy zaległości',
            jump: 'Przeskocz przy zaległości',
            seconds: ({ seconds }: { seconds: number }) => `${seconds} s`,
            noNaturalVoice: ({ language }: { language: string }) => `Dla języka ${language} nie ma zainstalowanego głosu ulepszonego ani premium, więc odpowiedzi czyta głos kompaktowy. W Ustawieniach otwórz Dostępność > Czytana zawartość > Głosy i pobierz jeden.`,
            openSettings: 'Otwórz Ustawienia',
        },
        cues: {
            title: 'Sygnały dźwiękowe',
            footer: 'Dźwięki na czas bez patrzenia na ekran. Wolne, niskie uderzenie, gdy coś działa, szybszy jasny puls, gdy coś czeka na ciebie, i cisza, gdy nic się nie dzieje. Mowa zawsze wygrywa: sygnał nigdy nie zagra na wypowiadanym zdaniu.',
            on: 'Sygnały dźwiękowe',
            onSubtitle: 'Puls i pojedyncze dźwięki.',
            heartbeat: 'Puls',
            heartbeatSubtitle: 'Bije, gdy trwa praca i nic nie jest wypowiadane.',
            volume: 'Głośność',
            workingEvery: 'Puls pracy co',
            waitingEvery: 'Puls oczekiwania co',
            titlesTitle: 'Wypowiadane tytuły',
            titlesFooter: 'Jednoliniowy tytuł wywołania narzędzia, terminala lub uruchamianego agenta, czytany szybciej i wyżej niż odpowiedź, żeby nigdy nie brzmiał jak mówiący Claude. Seria wywołań ma limit; agenci są nazywani zawsze.',
            speakTitles: 'Czytaj tytuły na głos',
            agentTitles: 'Tytuły agentów',
            agentTitlesSubtitle: 'Nigdy nie pomijane.',
            toolTitles: 'Tytuły narzędzi i terminala',
            titlesPerRun: 'Tytuły na serię wywołań',
            tableTitle: 'Dźwięki',
            tableFooter: 'Dotknij wiersza, aby go wyciszyć, albo przycisku odtwarzania, aby go usłyszeć.',
            play: 'Odtwórz',
        },
    },
    ...
    machine: {
        ...
        offlineHelp: '• Upewnij się, że komputer jest online\n• Uruchom `drover daemon status`, aby zdiagnozować\n• Czy używasz najnowszej wersji CLI? Zaktualizuj poleceniem `npm install -g drover@latest`',
    ...
    subagent: {
        ...
        failed: 'Niepowodzenie',
        quiet: ({ duration }: { duration: string }) => `cisza od ${duration}`,
