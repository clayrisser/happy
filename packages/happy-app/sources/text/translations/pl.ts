...
export const pl: TranslationStructure = {
    ...
    server: {
        ...
        continueWithServer: 'Ten sam klucz, to samo konto. Sesje nie idą z Tobą: nowy serwer zaczyna pusty.',
        ...
        advancedFeatureFooter: 'Zaawansowane. Zmiana loguje Cię na nowym serwerze kluczem, który już masz; bez wylogowania.',
        reauthenticating: 'Logowanie na nowym serwerze…',
        reauthFailed: 'Nie udało się tam zalogować Twoim kluczem. Nic się nie zmieniło.',
        services: 'Usługi',
    ...
    agentInput: {
        ...
        context: {
            ...
            percentContext: ({ percent }: { percent: number }) => `${percent}% kont.`,
    ...
    settingsVoice: {
        ...
        cues: {
            ...
            volume: 'Głośność',
            vsVoice: 'Poziom sygnałów vs głos',
    ...
    imageUpload: {
        ...
        notSupportedFragment: 'ten agent nie przyjmuje obrazów',
