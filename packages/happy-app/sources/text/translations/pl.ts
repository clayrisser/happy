...
export const pl: TranslationStructure = {
    ...
    settingsVoice: {
        ...
        speaking: {
            ...
            deliveryFooter: 'Tempo i wysokość dotyczą każdego głosu. Gdy głos zostaje w tyle za tekstem bardziej niż próg, porzuca zaległości, mówi „przeskakuję dalej” i kontynuuje od najnowszego zdania.',
            rate: 'Tempo',
            pitch: 'Wysokość',
            lag: 'Przeskocz dalej po',
