...
export const ca: TranslationStructure = {
    ...
    settingsVoice: {
        ...
        speaking: {
            ...
            deliveryFooter: 'La velocitat i el to s\'apliquen a qualsevol veu. Quan la veu queda enrere del text més enllà del llindar, descarta el que té pendent, diu «salto endavant» i continua des de la frase més recent.',
            rate: 'Velocitat',
            pitch: 'To',
            lag: 'Saltar endavant després de',
