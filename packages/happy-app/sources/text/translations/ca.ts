...
export const ca: TranslationStructure = {
    ...
    session: {
        ...
        forkErrorDirectoryMissing: ({ directory }: { directory: string }) =>
            `El directori ${directory} ja no existeix en aquella màquina, així que no hi ha on iniciar la nova sessió.`,
        cloneAction: 'Clona en un altre entorn…',
        cloneSubtitle: 'Torna a explicar aquesta conversa a Cursor, Pi o a un Claude nou',
        cloneSheetTitle: 'Clona en un altre entorn',
        cloneSheetSubtitle: "Una sessió nova a la mateixa carpeta, iniciada amb aquesta conversa reexplicada com a primer missatge. L'original no es toca.",
        cloneErrorGeneric: "No s'ha pogut clonar la sessió.",
        cloneErrorNotClaude: 'Només una sessió de Claude es pot clonar en un altre entorn: la seva conversa és la que el drover sap exportar.',
        cloneHarnessUnavailable: 'No està instal·lat en aquesta màquina',
    },
    ...
    server: {
        ...
        continueWithServer: 'Mateixa clau, mateix compte. Les sessions no et segueixen: el nou servidor comença buit.',
        ...
        advancedFeatureFooter: 'Avançat. En canviar s\'inicia sessió al nou servidor amb la clau que ja tens; sense tancar la sessió.',
        reauthenticating: 'Iniciant sessió al nou servidor…',
        reauthFailed: 'No s\'ha pogut iniciar sessió allà amb la teva clau. No ha canviat res.',
        services: 'Serveis',
    ...
    sessionInfo: {
        ...
        remoteControlTitle: 'Control remot',
        remoteControl: 'Control remot de Claude Code',
        remoteControlOn: 'Actiu — pots arribar a aquesta sessió des del mòbil i des de claude.ai/code',
        remoteControlOff: 'Inactiu — les respostes es queden al terminal',
        remoteControlPending: 'Esperant que s\'obri l\'indicador…',
        remoteControlUnknown: 'El terminal encara no ho ha dit',
        remoteControlFooter: 'Llegeix què fa realment el panell, així /remote-control escrit al terminal també apareix aquí.',
        remoteControlUnknownFooter: 'No es pot canviar res fins que la sessió informi si el control remot és actiu.',
        remoteControlTurnOn: 'Activa',
        remoteControlAtRiskTitle: 'Han quedat mudes després del canvi',
        remoteControlAtRiskFooter: 'Claude Code lliga el control remot a un compte per màquina, així que moure aquesta sessió el va desactivar per a aquestes.',
    ...
    agentInput: {
        ...
        dictate: {
            ...
            settingsSubtitle: 'Un botó de micròfon al camp de missatge: mantén premut per parlar, toca per deixar-lo obert. Es transcriu en aquest dispositiu.',
            listening: 'Escoltant…',
        ...
        channels: {
            ...
            phoneHapticsSubtitle: 'Avisos i els tocs sota el dit',
            phoneHapticsTitle: 'AQUEST TELÈFON',
            phoneHapticsFooter: 'Apagat per defecte. El rellotge vibra igual.',
        },
        codexPermissionMode: {
        ...
        usagePopup: {
            ...
            familyWeek: ({ family }: { family: string }) => `Setmana ${family}`,
            left: ({ percent }: { percent: number }) => `${percent}% restant`,
    ...
    toolGroup: {
        ...
        ranShellCommands: ({ count }: { count: number }) => count === 1 ? 'S\'ha executat 1 comanda de shell' : `S'han executat ${count} comandes de shell`,
    ...
    settingsVoice: {
        ...
        speaking: {
            ...
            automaticSubtitle: ({ name }: { name: string }) => `Millor veu instal·lada: ${name}`,
            automaticNone: 'No hi ha cap veu instal·lada per a aquesta llengua',
            preview: 'Escoltar',
            previewSentence: 'Les proves passen, dos fitxers han canviat i res més s\'ha mogut.',
            qualityPremium: 'Premium',
            qualityEnhanced: 'Millorada',
            qualityDefault: 'Compacta',
            personal: 'Veu personal',
            deliveryTitle: 'Lectura',
            deliveryFooter: 'La velocitat i el to s’apliquen a qualsevol veu. Una resposta acabada es llegeix fins al final, per llarga que sigui. Mentre encara s’escriu, si queda més àudio per dir que el llindar, la veu diu «salto endavant» i continua des de la frase més recent; i una resposta nova sempre abandona l’anterior.',
            rate: 'Velocitat',
            catchUpRate: 'Velocitat quan va endarrerit',
            pitch: 'To',
            backlog: 'Accelera amb un endarreriment de',
            jump: 'Salta amb un endarreriment de',
            seconds: ({ seconds }: { seconds: number }) => `${seconds} s`,
            noNaturalVoice: ({ language }: { language: string }) => `No hi ha cap veu millorada o premium instal·lada per a ${language}, així que les respostes fan servir la compacta. A Configuració, ves a Accessibilitat > Contingut llegit > Veus i descarrega\'n una.`,
            openSettings: 'Obrir Configuració',
        },
        cues: {
            title: 'Senyals d\'àudio',
            footer: 'Sons per no mirar la pantalla. Un cop greu i lent mentre alguna cosa s\'executa, un pols més ràpid i brillant mentre alguna cosa t\'espera, i silenci quan no passa res. La veu sempre guanya: un senyal mai sona per sobre d\'una frase parlada.',
            on: 'Senyals d\'àudio',
            onSubtitle: 'El batec i els sons puntuals.',
            heartbeat: 'Batec',
            ...
            titlesFooter: 'El títol d\'una línia d\'una crida a una eina, de terminal o d\'un agent en arrencar, llegit més ràpid i més agut que la resposta perquè mai soni com el Claude parlant. Una sèrie de crides té límit; els agents sempre s\'anomenen.',
            speakTitles: 'Llegir els títols en veu alta',
            agentTitles: 'Títols d\'agents',
            agentTitlesSubtitle: 'Mai s\'ometen.',
            toolTitles: 'Títols d\'eines i terminal',
            titlesPerRun: 'Títols per sèrie de crides',
            tableTitle: 'Els sons',
            tableFooter: 'Toca una fila per silenciar-la, o el botó de reproducció per sentir-la.',
            play: 'Reprodueix',
        },
    },
    ...
    subagent: {
        ...
        failed: 'Ha fallat',
        quiet: ({ duration }: { duration: string }) => `en silenci des de fa ${duration}`,
    ...
    imageUpload: {
        ...
        cameraPermissionMessage: 'Permet l’accés a la càmera per adjuntar fotos als missatges.',
    },
