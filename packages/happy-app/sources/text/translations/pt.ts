...
export const pt: TranslationStructure = {
    ...
    settingsVoice: {
        ...
        speaking: {
            ...
            deliveryFooter: 'Velocidade e tom valem para qualquer voz. Quando a voz fica atrás do texto além do limite, ela descarta o atraso, diz «pulando adiante» e continua da frase mais recente.',
            rate: 'Velocidade',
            pitch: 'Tom',
            lag: 'Pular adiante após',
