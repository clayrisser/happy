...
export const ru: TranslationStructure = {
    ...
    server: {
        ...
        continueWithServer: 'Тот же ключ — тот же аккаунт. Сессии не переносятся: новый сервер начинается пустым.',
        ...
        advancedFeatureFooter: 'Для опытных. Переключение выполняет вход на новый сервер вашим ключом; выходить не нужно.',
        reauthenticating: 'Вход на новый сервер…',
        reauthFailed: 'Не удалось войти туда с вашим ключом. Ничего не изменилось.',
        services: 'Сервисы',
    ...
    agentInput: {
        streamTalk: {
            ...
            paused: 'Пауза. Удерживайте, чтобы продолжить с того же места',
            resumed: 'Читаю дальше с того места, где остановилось',
            headphonesOff: 'Наушники отключены, чтение на паузе',
        },
        audioOut: {
        ...
        channels: {
            ...
            phoneHapticsSubtitle: 'Оповещения и отклики под пальцем',
            phoneHapticsTitle: 'ЭТОТ ТЕЛЕФОН',
            phoneHapticsFooter: 'По умолчанию выключено. Часы вибрируют.',
        },
        codexPermissionMode: {
    ...
    settingsVoice: {
        ...
        cues: {
            ...
            volume: 'Громкость',
            vsVoice: 'Уровень сигналов и голоса',
