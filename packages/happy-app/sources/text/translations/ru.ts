...
export const ru: TranslationStructure = {
    ...
    settingsVoice: {
        ...
        speaking: {
            ...
            deliveryFooter: 'Скорость и высота применяются к любому голосу. Когда голос отстаёт от текста больше порога, он сбрасывает очередь, говорит «пропускаю вперёд» и продолжает с последнего предложения.',
            rate: 'Скорость',
            pitch: 'Высота',
            lag: 'Пропускать вперёд после',
