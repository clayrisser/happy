...
export const ja: TranslationStructure = {
    ...
    server: {
        ...
        continueWithServer: '同じキーなら同じアカウントです。セッションは引き継がれず、新しいサーバーは空から始まります。',
        ...
        advancedFeatureFooter: '上級者向け。切り替えると、いま持っているキーで新しいサーバーにサインインします。ログアウトは不要です。',
        reauthenticating: '新しいサーバーにサインインしています…',
        reauthFailed: 'そのサーバーにはこのキーでサインインできませんでした。変更はありません。',
        services: 'サービス',
    ...
    sessionInfo: {
        ...
        remoteControlTitle: 'リモートコントロール',
        remoteControl: 'Claude Code リモートコントロール',
        remoteControlOn: 'オン — このセッションはスマホと claude.ai/code から操作できます',
        remoteControlOff: 'オフ — 返信はターミナルにとどまります',
        remoteControlPending: 'プロンプトが空くのを待っています…',
        remoteControlUnknown: 'ターミナルからまだ報告がありません',
        remoteControlFooter: 'ペインの実際の状態を読み取るので、ターミナルで打った /remote-control もここに反映されます。',
        remoteControlUnknownFooter: 'リモートコントロールの状態がセッションから届くまで切り替えられません。',
        remoteControlTurnOn: 'オンにする',
        remoteControlAtRiskTitle: 'アカウント切り替えで静かになったセッション',
        remoteControlAtRiskFooter: 'Claude Code はリモートコントロールをマシンごとに 1 アカウントへ結び付けるため、このセッションの移動でこれらが切れました。',
        viewMachine: 'マシンを表示',
    ...
    agentInput: {
        ...
        channels: {
            ...
            phoneHapticsSubtitle: '通知と、指の下の小さなタップ',
            phoneHapticsTitle: 'この端末',
            phoneHapticsFooter: '既定はオフ。時計は変わらず振動します。',
        },
        codexPermissionMode: {
            title: 'CODEX権限モード',
            default: 'CLI設定',
    ...
    settingsVoice: {
        ...
        speaking: {
            ...
            automatic: '自動',
            automaticSubtitle: ({ name }: { name: string }) => `インストール済みで最良の声: ${name}`,
            automaticNone: 'この言語の声がインストールされていません',
            preview: '試聴',
            previewSentence: 'テストは通り、2つのファイルが変わり、ほかは何も動いていません。',
            qualityPremium: 'プレミアム',
            qualityEnhanced: '拡張',
            qualityDefault: 'コンパクト',
            personal: 'パーソナルボイス',
            deliveryTitle: '話し方',
            deliveryFooter: '速さと高さはすべての声に適用されます。書き終わった返答は、どれだけ長くても最後まで読み上げます。まだ書かれている途中で、未読の音声がしきい値を超えたときだけ「先に進みます」と言って最新の文から続けます。新しい返答は常に前の返答を打ち切ります。',
            rate: '速さ',
            catchUpRate: '遅れているときの速さ',
            pitch: '高さ',
            backlog: '遅れがこの長さを超えたら速める',
            jump: '遅れがこの長さを超えたら飛ばす',
            seconds: ({ seconds }: { seconds: number }) => `${seconds} 秒`,
            noNaturalVoice: ({ language }: { language: string }) => `${language} の拡張またはプレミアムの声がインストールされていないため、返信はコンパクトな声で読まれます。設定の アクセシビリティ > 読み上げコンテンツ > 声 からダウンロードしてください。`,
            openSettings: '設定を開く',
        },
        cues: {
            title: 'オーディオキュー',
            footer: '画面を見ずに状況をつかむための音です。何かが動いている間はゆっくり低い鼓動、あなたの返事を待っている間は速く明るいパルス、何も起きていないときは無音。音声が常に優先され、キューが話し声に重なることはありません。',
            on: 'オーディオキュー',
            onSubtitle: '鼓動と単発の音。',
            heartbeat: '鼓動',
            ...
            titlesFooter: 'ツール呼び出し、ターミナル呼び出し、起動したエージェントの1行タイトルを、返答より速く高い声で読み上げます。連続したツール呼び出しには上限があり、エージェントは常に読み上げます。',
            speakTitles: 'タイトルを読み上げる',
            agentTitles: 'エージェントのタイトル',
            agentTitlesSubtitle: '省略しません。',
            toolTitles: 'ツールとターミナルのタイトル',
            titlesPerRun: '連続呼び出しごとのタイトル数',
            tableTitle: '音の一覧',
            tableFooter: '行をタップすると消音、再生ボタンで試聴できます。',
            play: '再生',
        },
    },
    ...
    imageUpload: {
        ...
        notSupportedFragment: 'このエージェントは画像を扱えません',
