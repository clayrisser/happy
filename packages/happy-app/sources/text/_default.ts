...
export const en = {
    ...
    settingsVoice: {
        ...
        speaking: {
            ...
            deliveryFooter: 'Speed and pitch apply to every voice. A finished reply is read to the end, however long it is. While one is still being written, more unspoken audio than the threshold makes the voice say "skipping ahead" and continue from the newest sentence, and a new reply always abandons the old one.',
            rate: 'Speed',
            pitch: 'Pitch',
            backlog: 'Skip ahead when behind by',
