...
export const en = {
    ...
    settings: {
        ...
        about: 'About',
        aboutFooter: 'Cattle Drover is a Codex and Claude Code mobile client. It\'s fully end-to-end encrypted and your account is stored only on your device. Not affiliated with Anthropic.',
        whatsNew: 'What\'s New',
    ...
    settingsAppearance: {
        ...
        compactToolCallsDescription: 'Fold edit diffs and agent cards to one line as well. Shell, read and search calls are always one line.',
        showLineNumbersInToolViews: 'Line Numbers in Diffs',
        showLineNumbersInToolViewsDescription: 'Number the lines in edit and write diffs',
        ...
        showHarnessIconInSessionHeader: 'Harness in Header',
        showHarnessIconInSessionHeaderDescription: 'Show the harness icon beside the session name',
        showHarnessIconsInSessionList: 'Harness in List',
        showHarnessIconsInSessionListDescription: 'Show harness badges on session-list avatars',
        avatars: 'Avatars',
    ...
    settingsFeatures: {
        ...
        groupToolCalls: 'Fold Finished Turns',
        groupToolCallsSubtitle: 'One "Worked 2m" row per finished turn, opening onto its calls',
    },
    ...
    imageUpload: {
        ...
        cameraPermissionMessage: 'Allow access to your camera to attach photos to messages.',
    },
    ...
    server: {
        ...
        notValidHappyServer: 'Not a valid Drover server',
        changeServer: 'Change Server',
        continueWithServer: 'Same key, same account. Sessions do not follow: the new server starts empty.',
        ...
        advancedFeatureFooter: "Advanced. Switching signs you in to the new server with the key you already have — no logout.",
        reauthenticating: 'Signing in to the new server…',
        reauthFailed: 'Could not sign in there with your key. Nothing changed.',
        services: 'Services',
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'Drover Session ID copied to clipboard',
        failedToCopySessionId: 'Failed to copy Drover Session ID',
        ...
        // DROVE-63: Claude Code's own Remote Control, toggled from the phone.
        remoteControlTitle: 'Remote Control',
        remoteControl: 'Claude Code Remote Control',
        remoteControlOn: 'On — this session is reachable from your phone and claude.ai/code',
        remoteControlOff: 'Off — replies stay in the terminal',
        remoteControlPending: 'Waiting for the prompt to open…',
        remoteControlUnknown: 'The terminal has not said yet',
        remoteControlFooter: 'Reads what the pane is actually doing, so /remote-control typed in the terminal shows up here too.',
        remoteControlUnknownFooter: 'Nothing can be switched until the session reports whether Remote Control is on.',
        remoteControlTurnOn: 'Turn on',
        remoteControlAtRiskTitle: 'Went quiet after the switch',
        remoteControlAtRiskFooter: 'Claude Code binds Remote Control to one account per machine, so switching this session dropped it for these.',
        ...
        updateCliInstructions: 'Please run npm install -g drover@latest',
    ...
    components: {
        emptyMainScreen: {
            ...
            installCli: 'Install the Drover CLI',
            runIt: 'Run it',
    ...
    agentQuestion: {
        ...
        unsupportedDescription: ({ kind }: { kind: string }) =>
            `This version of Cattle Drover cannot show a "${kind}" request. Update the app to respond.`,
    ...
    toolGroup: {
        ...
        ranShellCommands: ({ count }: { count: number }) => count === 1 ? 'Ran 1 shell command' : `Ran ${count} shell commands`,
    ...
    tools: {
        ...
        taskView: {
            ...
            showAll: ({ count }: { count: number }) => `Show all ${count} ${plural({ count, singular: 'step', plural: 'steps' })}`,
            showLess: 'Show less',
        },
        multiEdit: {
    ...
    settingsVoice: {
        ...
        speaking: {
            ...
            deliveryFooter: 'Speed and pitch apply to every voice. A finished reply is read to the end, however long it is. While one is still being written, the voice moves to the faster speed once it is behind by the first amount, and only jumps to the newest sentence once it is behind by the second. A new reply always abandons the old one.',
            rate: 'Speed',
            catchUpRate: 'Speed when behind',
            pitch: 'Pitch',
            backlog: 'Speed up when behind by',
            jump: 'Jump ahead when behind by',
        ...
        cues: {
            ...
            titlesFooter: 'The one-line title of a tool call, a terminal call or an agent as it spawns, read faster and higher than the reply so it never sounds like Claude talking. A run of tool calls is capped; agents are always named.',
            speakTitles: 'Read titles aloud',
            agentTitles: 'Agent titles',
            agentTitlesSubtitle: 'Never folded away.',
            toolTitles: 'Tool titles',
            titlesPerRun: 'Titles per run of tool calls',
            tableTitle: 'The sounds',
            tableFooter: 'Tap a row to silence it, or the play button to hear it.',
            play: 'Play',
        },
    },
    ...
    terminal: {
        ...
        terminalRequestDescription: 'A terminal is requesting to connect to your Cattle Drover account. This will allow the terminal to send and receive messages securely.',
    ...
    machine: {
        ...
        offlineHelp: '• Make sure your computer is online\n• Run `drover daemon status` to diagnose\n• Are you running the latest CLI version? Upgrade with `npm install -g drover@latest`',
        daemon: 'Daemon',
        status: 'Status',
    ...
    subagent: {
        ...
        waitingUnknown: 'The transcript is not coming through, and the app cannot tell why.',
