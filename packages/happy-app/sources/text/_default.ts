...
export const en = {
    ...
    sessionInfo: {
        ...
        remoteControlAtRiskTitle: 'Went quiet after the flip',
        remoteControlAtRiskFooter: 'Claude Code binds Remote Control to one account per machine, so moving this session dropped it for these.',
